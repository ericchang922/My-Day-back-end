...
class GroupList(models.Model):
    ...
    type_id = models.IntegerField(blank=True, null=True)
    status_id = models.IntegerField()
    inviter_id = models.CharField(max_length=255, db_collation='utf8_general_ci')
    inviter_name = models.CharField(max_length=255, db_collation='utf8_general_ci', blank=True, null=True)
    inviter_photo = models.TextField(blank=True, null=True)
